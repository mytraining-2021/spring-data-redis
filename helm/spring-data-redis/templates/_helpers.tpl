...
{{ include "spring-data-redis.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
*/}}
{{- define "spring-data-redis.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "spring-data-redis.fullname" .) .Values.serviceAccount.name }}
{{- else }}
